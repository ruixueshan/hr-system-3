<template>
  <div class="salary-page">
    <el-tabs v-model="activeTab" type="card">
      ...
      <el-tab-pane label="日结发薪" name="daily">
        ...
        <el-dialog v-model="salaryDialogVisible" title="薪资计算预览" width="1200px">
          ...
          <template #footer>
            ...
            <el-button type="primary" @click="handleBatchPay">确认发薪</el-button>
          </template>
        </el-dialog>

        <el-dialog v-model="payDialogVisible" title="确认批量发薪" width="400px">
          ...
          <template #footer>
            ...
            <el-button type="primary" :loading="paying" @click="confirmBatchPay">确认发薪</el-button>
          </template>
        </el-dialog>
      </el-tab-pane>
...
const activeTab = ref<'monthly' | 'daily' | 'daily-query' | 'monthly-query'>('monthly');
...
async function loadInitialSalaryPageData() {
  const tasks = [
    { name: '日结发薪数据', load: loadDailyData },
